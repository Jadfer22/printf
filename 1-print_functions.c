...
/**
 * print_octal - function that prints
...
/**
 * print_hexa_upper - function thta prints an
...
/****** PRINT HEXX NUM IN LOWER OR UPPERCASE ******/
/**
 * print_hexa - function that prints a
 * hexadecimal number in lower or uppercase
 * @types: list of arguments
